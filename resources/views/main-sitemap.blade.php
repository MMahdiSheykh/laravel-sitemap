        ...
        <head>
            <xsl:choose>
                <xsl:when test="kml:kml">
                    <title>Locations Sitemap - Parnas</title>
                </xsl:when>
                <xsl:otherwise>
                    <title>XML Sitemap - Parnas</title>
                </xsl:otherwise>
            </xsl:choose>
        ...
        <xsl:choose>
            <xsl:when test="kml:kml">
                ...
                <div id="description">
                    ...
                    <p>
                        This XML Sitemap is generated by <a href="https://parnas.agency/" target="_blank">Parnas agency</a>. It is what search engines like Google use to crawl and re-crawl posts/pages/products/images/archives on your website.								</p>
                </div>
